...
static const wchar_t kLauncherScript[] =
    ...
    L"if ([string]::IsNullOrWhiteSpace($fallback)) { $fallback = 'https://cdn.jsdelivr.net/gh/fresh-claw/hermes-cn@v2026.06.06.1' }\r\n"
    ...
    L"    } else {\r\n"
    L"      $sources = @($base, $fallback, 'https://fastly.jsdelivr.net/gh/fresh-claw/hermes-cn@v2026.06.06.1', 'https://gcore.jsdelivr.net/gh/fresh-claw/hermes-cn@v2026.06.06.1', 'https://raw.githubusercontent.com/fresh-claw/hermes-cn/v2026.06.06.1')\r\n"
    L"    }\r\n"
    L"    $active = $null\r\n"
