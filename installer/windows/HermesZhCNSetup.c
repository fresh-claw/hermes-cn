...
static const wchar_t kLauncherScript[] =
    ...
    L"if ([string]::IsNullOrWhiteSpace($fallback)) { $fallback = 'https://cdn.jsdelivr.net/gh/fresh-claw/hermes-cn@v2026.06.08.2' }\r\n"
    ...
    L"  return ($text -and $text.Contains('Hermes 中文增强') -and $text.Contains('Find-HermesCommand') -and $text.Contains('v2026.06.08.2'))\r\n"
    L"}\r\n"
    ...
    L"    } else {\r\n"
    L"      $sources = @($base, $fallback, 'https://fastly.jsdelivr.net/gh/fresh-claw/hermes-cn@v2026.06.08.2', 'https://gcore.jsdelivr.net/gh/fresh-claw/hermes-cn@v2026.06.08.2', 'https://raw.githubusercontent.com/fresh-claw/hermes-cn/v2026.06.08.2')\r\n"
    L"    }\r\n"
    L"    $active = $null\r\n"
